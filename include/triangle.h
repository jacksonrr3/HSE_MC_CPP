...
public:
    Triangle(const Point v_1, const Point v_2, const Point v_3, const BWColor& color) : Shape(color) {
        fillPoints(v_1, v_2, v_3);
    }

    Triangle(const Point v_1, const Point v_2, const Point v_3, const RGBColor& color) : Shape(color) {
        fillPoints(v_1, v_2, v_3);
    }
